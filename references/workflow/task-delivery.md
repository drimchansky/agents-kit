...
- Without a declared pattern, use `./task-delivery-edges.md` § *Proposing an observed branch convention*, or default to **`task/<slug>`**. History may support a proposal, never an undeclared convention used silently.

...
Two of the surfaces it reads are swept but **never written into**, and the inclusion test they pass is what every surface the report leaves out fails: `./reconciliation.md` § *Never-annotated surfaces* names the two and owns both.

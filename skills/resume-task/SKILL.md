...
- [ ] Nothing written, edited, renamed, or deleted anywhere; no git mutation, external systems fetched read-only, no `BRIEF.md` or scratch briefing file
